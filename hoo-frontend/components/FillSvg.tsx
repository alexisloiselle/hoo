...
const CustomFillSvg = ({ currentValue, maxValue, width, height }) => {
  // Calculate the percentage filled
  const getPercentage = (currentValue, maxValue) => {
    return 200 - (currentValue / maxValue) * 200;
  };

  const fillHeight = useSharedValue(100);

  useEffect(() => {
    fillHeight.value = getPercentage(currentValue, maxValue);
          ...
          <Svg width={width} height={height}>
            <Defs>
              ...
              >
                ...
                <Stop offset={`50%`} stopColor="#4e92eb" />
              </LinearGradient>
            </Defs>
            <Path
